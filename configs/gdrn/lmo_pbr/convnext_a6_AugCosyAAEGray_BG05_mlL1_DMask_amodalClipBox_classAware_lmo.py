...
VAL = dict(
    ...
    ERROR_TYPES="mspd,mssd,ad,reS,teS",  # dropped vsd: it needs a renderer and bop_renderer is a dangling symlink here. Re-add vsd once a renderer (egl) is wired.
    RENDERER_TYPE="egl",  # cpp needs the (missing) bop_renderer; egl renderer is built into the image
    SPLIT="test",
    SPLIT_TYPE="",
